...
exports.customDataCount = function() {
	let resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "CODBEX_SALARYITEMDIRECTION"');
...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-perseus/Settings/SalaryItemDirection");
	try {
