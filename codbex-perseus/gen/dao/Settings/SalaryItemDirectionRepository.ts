...
export class SalaryItemDirectionRepository {
    ...
    public customDataCount(options?: SalaryItemDirectionEntityOptions): number {
    ...
    private async triggerEvent(data: SalaryItemDirectionEntityEvent) {
        ...
        producer.topic("codbex-perseus/Settings/SalaryItemDirection").send(JSON.stringify(data));
    }
}