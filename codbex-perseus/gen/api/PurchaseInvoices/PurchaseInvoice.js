...
const dao = require("codbex-perseus/gen/dao/PurchaseInvoices/PurchaseInvoice");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-perseus/gen/api/PurchaseInvoice.js/" + entity.Id);
