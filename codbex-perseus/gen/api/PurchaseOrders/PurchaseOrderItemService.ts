...
import { PurchaseOrderItemRepository, PurchaseOrderItemEntityOptions } from "../../dao/PurchaseOrders/PurchaseOrderItemRepository";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-perseus-PurchaseOrders-PurchaseOrderItem", ["validate"]);
...
class PurchaseOrderItemService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-perseus/gen/api/PurchaseOrders/PurchaseOrderItemService.ts/" + entity.Id);
