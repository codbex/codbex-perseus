...
const dao = require("codbex-perseus/gen/dao/SalesOrders/SalesOrderItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-perseus/gen/api/SalesOrderItem.js/" + entity.Id);
