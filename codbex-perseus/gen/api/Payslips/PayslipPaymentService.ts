...
class PayslipPaymentService {
    ...
    private readonly repository = new PayslipPaymentRepository();

    @Get("/")
    public getAll(_: any, ctx: any) {
        try {
            const options: PayslipPaymentEntityOptions = {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-perseus/gen/api/Payslips/PayslipPaymentService.ts/" + entity.Id);
