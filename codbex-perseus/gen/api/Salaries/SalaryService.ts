...
const validationModules = await Extensions.loadExtensionModules("codbex-perseus-Salaries-Salary", ["validate"]);
...
class SalaryService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-perseus/gen/api/Salaries/SalaryService.ts/" + entity.Id);
