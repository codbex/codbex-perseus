...
const dao = require("codbex-perseus/gen/dao/Settings/Currency");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-perseus/gen/api/Currency.js/" + entity.Id);
