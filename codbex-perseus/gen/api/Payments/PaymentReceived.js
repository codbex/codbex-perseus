...
const dao = require("codbex-perseus/gen/dao/Payments/PaymentReceived");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-perseus/gen/api/PaymentReceived.js/" + entity.Id);
