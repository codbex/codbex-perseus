...
@Controller
class PaymentSalesInvoiceService {

    private readonly repository = new PaymentSalesInvoiceRepository();

    @Get("/")
    public getAll(_: any, ctx: any) {
        try {
            const options: PaymentSalesInvoiceEntityOptions = {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-perseus/gen/api/Payments/PaymentSalesInvoiceService.ts/" + entity.Id);
